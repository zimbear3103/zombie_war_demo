...
public class GamePlayController : Singleton<GamePlayController>
{
    ...
    public void OnSetupGameLevel(int songIndex)
    {
        ...
        if (BeatMapLoader.Instance != null && BeatMapLoader.Instance.LoadSong(songIndex) && Conductor.Instance != null)
        {
            Conductor.Instance.PlaySong(BeatMapLoader.Instance.CurrentClip);
        }
    }
    ...
    public void LeaveSettingPopupStatus()
    {
        ...
        if (IsGamePlaying && Conductor.Instance != null)
